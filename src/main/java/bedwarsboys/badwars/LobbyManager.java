...
public class LobbyManager {
    ...
    boolean backupLobbyLocation() {
        ...
        areaBackup = new WorldBlockArea(lobbyLocation.clone().add(-4, -1, -4), lobbyLocation.clone().add(4, 5, 4));
        if (!areaBackup.saveBlockArea("lobby_area_orig", true)) {
